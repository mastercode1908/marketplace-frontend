...
export default function RegisterPage() {
  ...
  const handleGoogleRegister = () => {
    ...
    }auth/google/register?role=${roleType}`;
  };

  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 flex items-center justify-center p-4 py-12 relative">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 space-y-6">
          ...
          <form onSubmit={handleRegister} className="space-y-3">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-4 py-2 bg-slate-50 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition ${
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-2 bg-slate-50 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition ${
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-10 py-2 bg-slate-50 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition ${
          ...
          >
            <svg className="w-5 h-5" viewBox="0 0 48 48">
              {" "}
              {/* icon chỉ tăng 1 size so với cũ */}
              <path
                fill="#FFC107"
